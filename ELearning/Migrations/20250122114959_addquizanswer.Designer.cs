...
namespace ELearning.Migrations
{
    ...
    [Migration("20250122114959_addquizanswer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearning_Core.Model.Faculty.BatchSubject", b =>
                {
                    ...
                    b.Property<DateTime?>("EndTiming")
                        .HasColumnType("datetime2");

                    b.Property<int>("FacultyId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("StartTiming")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ELearning_Core.Model.Faculty.Batch", b =>
                {
                    b.HasOne("ELearning_Core.Model.Master.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("ELearning_Core.Model.Faculty.Faculty", b =>
                {
                    b.HasOne("ELearning_Core.Model.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("ELearning_Core.Model.Master.HelpDesk", b =>
                {
                    ...
                    b.HasOne("ELearning_Core.Model.Student.StudentInfo", "StudentInfo")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ELearning_Core.Model.Master.SubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("ELearning_Core.Model.Quiz.QuizAnswer", b =>
                {
                    b.HasOne("ELearning_Core.Model.Quiz.QuizOption", "QuizOption")
                        .WithMany()

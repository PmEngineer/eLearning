...
CKEDITOR.editorConfig = function (config) {
	...
	config.removeButtons = 'baloontoolbar,easyimage,cloudservices ,find, editing,Form, smiley,Iframe,Anchor,Language,CreateDiv', 'document', 'exportpdf','about';
	//config.extraPlugins = 'mathjax';
	config.fontSize_defaultLabel = '14px';
	config.filebrowserUploadUrl = '/Editor/Upload/';
		config.filebrowserUploadMethod = 'form';
	config.filebrowserBrowseUrl = '/Editor/FileBrowse/';

...
$(document).ready(function () {
            ...
            if (RESULT) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        CKEDITOR.instances['HindiSolution'].setData("");
                        CKEDITOR.instances['EnglishQ'].setData("");
                        CKEDITOR.instances['EnglishSolution'].setData("");
                        $("input[type=radio][name=selectedRow]").prop('checked', false);
                    },
                    error: function () {
                        alert("Error occured!!")
                    }
    ...
    CKEDITOR.replace('EnglishSolution', { language: 'en' });
    CKEDITOR.replace('HindiSolution',
        {
            language: 'hi'
        });
